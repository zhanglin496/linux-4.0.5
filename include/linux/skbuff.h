 ...
 *
 //Ğ£ÑéºÍÒÑ¾­ÓÉĞ­ÒéÕ»¼ÆËãÍê³É£¬Ó²¼şÎŞĞëÔÙ´Î¼ÆËã
 * CHECKSUM_NONE:
 *
 *   The skb was already checksummed by the protocol, or a checksum is not
 *   required.
 *
 //ÒªÇóÓ²¼ş¼ÆËãÖ¸¶¨Êı¾İµÄĞ£ÑéºÍ
 * CHECKSUM_PARTIAL:
 *
...
struct skb_frag_struct {
	...
	__u16 size; //  ÔÚpÖ¸ÏòµÄpageÖĞ±¾Æ¬¶ÎµÄÊı¾İ³¤¶È £¬ÒòÎª¿ÉÄÜ¹²ÓÃÍ¬Ò»¸öpage 
#endif
};
...
struct skb_shared_info {
	unsigned char	nr_frags;  // ·ÖÒ³¶ÎÊıÄ¿£¬¼´fragsÊı×éÔªËØ¸öÊı  
	__u8		tx_flags;
	//Í¨ÓÃ·Ö¶ÎĞ¶ÔØ
	//ethtool -k eth1
	...
	//Ç°3¸öÊÇÎªÁË´«ÊäÊı¾İµÄ£¬ºó2¸öÊÇÎªÁË½ÓÊÕÊı¾İµÄ¡£
	unsigned short	gso_size; //Ã¿¸öÍ¨ÓÃ·Ö¶ÎĞ¶ÔØµÄ´óĞ¡
	/* Warning: this field is not always filled in (UFO)! */
	unsigned short	gso_segs; //Í¨ÓÃ·Ö¶ÎĞ¶ÔØµÄÊıÄ¿
...
#define PKT_TYPE_OFFSET()	offsetof(struct sk_buff, __pkt_type_offset)
	...
	//·ñÔòÈç¹ûÊı¾İ°ü³¬¹ımtu£¬iph->frag_offÉèÖÃÁËDF²¢ÇÒignore_dfÎª0
	//Êı¾İ°ü½«±»¶ªÆú
	__u8			ignore_df:1;
	__u8			nfctinfo:3;
