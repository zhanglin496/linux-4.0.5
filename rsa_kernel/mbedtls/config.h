...
//#define MBEDTLS_PLATFORM_STD_PRINTF        printk /**< Default printf to use, can be undefined */
...
#define MBEDTLS_PLATFORM_CALLOC_MACRO(n, size)        kcalloc(n, size, GFP_ATOMIC) /**< Default allocator macro to use, can be undefined */
#define MBEDTLS_PLATFORM_MALLOC_MACRO(size)        kmalloc(size, GFP_ATOMIC) /**< Default allocator macro to use, can be undefined */
#define MBEDTLS_PLATFORM_FREE_MACRO            kfree /**< Default free macro to use, can be undefined */
