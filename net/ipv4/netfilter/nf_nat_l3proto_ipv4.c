...
//±ÈÈç±¾µØ·¢³öµÄÊý¾Ý°üµ½Ä¿µÄµØC:80¶Ë¿Ú£¬±êÎªÁ¬½ÓA
//È»ºó´æÔÚ×ª·¢µÄÊý¾Ý°üÒ²ÊÇµ½Ä¿µÄµØC:80¶Ë¿Ú,±êÎªÁ¬½ÓB
//¼ÙÉè¶¼¾­¹ýÁËC ¾­¹ýÁËNAT×ª»»£¬±äÎªD:8080
//È»ºóÉ¾³ýNAT¹æÔò
//ÓÉÓÚÁ¬½ÓA²»ÖªµÀ8080¶Ë¿Ú±»Õ¼ÓÃÁË£¬²¢ÇÒAÒªÊ¹ÓÃDÕâ¸öµØÖ·£¬Èç¹ûAÊ¹ÓÃD:8080¶Ë¿Ú
//¾Í»á³åÍ»£¬ËùÒÔÕâÖÖÇé¿öÏÂA±ØÐëÖ´ÐÐÒ»´Î¿Õ°ó¶¨£¬Ñ¡ÔñÒ»¸ö
//ÁíÍâµÄÔ´¶Ë¿ÚºÅ
unsigned int
					...
					struct nf_conn *ct))
{
	...
	case IP_CT_RELATED_REPLY:
		//»á³öÏÖIP_CT_RELATEDµÄÇé¿ö
		//±ÈÈç¶ÔÓÚUDP ÓÐ¿ÉÄÜÁ¬½ÓµÄ·¢Æð·½¹Ø±ÕÁËÌ×½Ó×Ö
		//Èç¹û¶Ô¶ËÔÙ·¢Êý¾Ý£¬¾Í»á³öÏÖICMP_DEST_UNREACH´íÎó
		//Èç¹ûÊÇICMPÐ­Òé£¬ÐèÒª×öÌØÊâµÄNAT´¦Àí
		//Ç°ÌáÊÇskb ÎªIP_CT_RELATEDÀàÐÍµÄ£¬
		//Èç¹û²»ÊÇ¾Í²»ÐèÒª×öÌØ±ðµÄ´¦Àí
	...
	case IP_CT_NEW:
		...
		if (!nf_nat_initialized(ct, maniptype)) {
			...
			//Éè±¸ÓÐ±ä»¯£¬±ÈÈçÔÚ¶àwanµÄÇé¿öÏÂ£¬Ã¿´ÎÑ¡ÔñµÄ³ö¿ÚÓÐ±ä»¯£¬ÐèÒªÏú»Ùconntrack
			//ÕâÀïÒâË¼Ó¦¸ÃÊÇ¶ÔÓÚÍ¬Ò»ÌõÊý¾ÝÁ÷Ó¦¸ÃÊ¼ÖÕÑ¡ÔñÍ¬Ò»¸ö³ö¿Ú
			//³ý·ÇÉè±¸×¢ÏúÁË»òÕßÈ·Êµ²»¿ÉÓÃ
